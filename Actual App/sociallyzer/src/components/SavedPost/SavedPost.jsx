...
export default function PostInAGrid({post, imageNumber="1", mouseEnter, mouseLeave, hoveringOver, id}){ // VERY IMPORTANT NOTE : Please study the staggering and hovering logic in the parent component (SavedPostsPage)
